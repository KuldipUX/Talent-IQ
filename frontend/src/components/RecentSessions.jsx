    ...
    <div className="card bg-base-100 border-2 border-accent/20 hover:border-accent/30 mt-8">
      <div className="card-body">
        <div className="flex items-center gap-3 mb-6">
          <div className="brutal-icon brutal-icon-pink p-2 rounded-xl">
                ...
                <div className="card-body p-5">
                  ...
                  <div className="flex items-center justify-between pt-3 border-t border-base-300">
                    <span className="text-xs font-semibold opacity-80 uppercase">
                      {session.status === "completed" ? "Completed" : session.status === "expired" ? "Expired" : session.status === "closed" ? "Closed" : "Session"}
                    </span>
