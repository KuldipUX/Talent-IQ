      ...
      <div className="card-body">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-3">
            <div className="brutal-icon brutal-icon-yellow p-2 rounded-xl">
              ...
              >
                <div className="flex items-center justify-between gap-4 p-5">
                  ...
                  <div className="flex items-center gap-4 flex-1">
                    <div className="relative size-14 rounded-xl brutal-yellow flex items-center justify-center">
                      <Code2Icon className="size-7 text-ink" />
                  ...
                  {session.status !== "active" ? (
                    <span className="badge badge-lg badge-outline">
                      {session.status === "completed" ? "Completed" : session.status === "expired" ? "Expired" : "Closed"}
                    </span>
                  ) : session.participant && !isUserInSession(session) ? (
